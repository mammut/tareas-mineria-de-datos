...
En el presente informe se comparan los algoritmos Apriori y FP-growth buscando reglas de asociación sobre el dataset de \textit{supermarket.arff} utilizando el software Weka\footnote{http://www.cs.waikato.ac.nz/ml/weka/}. La idea es comparar los comportamientos de ambos algoritmos al variar los parámetros de soporte mínimo y confianza.
